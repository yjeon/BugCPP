...
public:    
     ...
     */
    bool ArePointsNear(const double x1, const double y1, const double x2, const double y2) const {
     ...
     */
    bool IsPointNearLine(const double px,  const double py, const double s1x, const double s1y, const double s2x, const double s2y) const {
